...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c7 = function(field, op, literal) {
        ...
        peg$c20 = function() {
                    	let quotesRemoved = text().replace(/'/g, '');
                        return isNaN(parseFloat(quotesRemoved)) ? 
                        		quotesRemoved :
                                parseFloat(quotesRemoved)
                    },
        peg$c21 = "<=",
